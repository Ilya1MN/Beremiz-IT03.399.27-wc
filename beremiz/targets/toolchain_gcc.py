...
class toolchain_gcc():
    ...
    """
    def __init__(self, CTRInstance: ProjectController):
    ...
    def getBuilderCFLAGS(self):
        ...
        """
        return [self.CTRInstance.GetTarget().getcontent().getCFLAGS() + "-m32"]
    ...
    def check_and_update_hash_and_deps(self, bn):
        ...
        # compute new hash
        newhash = hashlib.md5(src.encode('utf-8')).hexdigest()
        # compare
    ...
    def calc_source_md5(self):
        ...
        return hashlib.md5(wholesrcdata.encode('utf-8')).hexdigest()
