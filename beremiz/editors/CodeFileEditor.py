...
HIGHLIGHT_TYPES = {(ERROR_HIGHLIGHT[0].GetIM(),
                    ERROR_HIGHLIGHT[1].GetIM()): STC_CODE_ERROR, (SEARCH_RESULT_HIGHLIGHT[0].GetIM(),
                                                                  SEARCH_RESULT_HIGHLIGHT[1].GetIM()): STC_CODE_SEARCH_RESULT}
...
class CodeEditor(CustomStyledTextCtrl):
    ...
    def __init__(self, parent, window, controler):
        ...
        for section in self.Controler.SECTIONS_NAMES:
            ...
            section_comment = \
                self.COMMENT_HEADER * int((len_headers / 2)) + \
                section_comment + \
                self.COMMENT_HEADER * int((len_headers - len_headers / 2))
...
class VariablesEditor(wx.Panel):
    ...
    def __init__(self, parent, window, controler):
        ...
        self.ColSizes = [0, 150] + [130]*(len(self.VariablesDefaultValue)-1)
    ...
    def OnVariablesGridEditorShown(self, event):
        ...
        if self.Table.GetColLabelValue(col, False) == "Type":
            ...
            type_menu.Append(wx.NewId(), "Base Types", base_menu)
            ...
            type_menu.Append(wx.NewId(), "User Data Types", datatype_menu)
    ...
    def OnVariablesGridCellLeftClick(self, event):
        if event.GetCol() == 0:
            ...
            return
        #self.VariablesGrid.SelectRow(self.VariablesGrid.GetGridCursorRow(), False)
        event.Skip()
