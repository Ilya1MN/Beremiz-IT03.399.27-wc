...
from controls import ProjectPropertiesPanel, VariablePanelConfiguration
...
class ProjectNodeEditor(ConfTreeNodeEditor):
    ...
    def _create_VariablePanel(self, prnt):
        pass
        pass
        self.VariableEditorPanel = VariablePanelConfiguration(prnt, self, self.Controler, "config", self.Debug)
