...
class SearchResultPanel(wx.Panel):
    ...
    def _init_coll_MainSizer_Growables(self, parent):
        parent.AddGrowableCol(0, proportion=1)
        parent.AddGrowableRow(1, proportion=1)
    ...
    def _init_ctrls(self, prnt):
        ...
        #search_results_tree_style = CT.TR_DEFAULT_STYLE | CT.TR_ELLIPSIZE_LONG_ITEMS
        ...
        self.SearchResultsTree = CT.CustomTreeCtrl(id=ID_SEARCHRESULTPANELSEARCHRESULTSTREE,
                                                   ...
                                                   agwStyle=CT.TR_ELLIPSIZE_LONG_ITEMS | CT.TR_ALIGN_WINDOWS | CT.TR_EXTENDED)
        self.SearchResultsTree.SetBackgroundColour(wx.Colour("WHITE"))
    ...
    def GenerateSearchResultsTreeBranch(self, root, infos):
        ...
        infos["matches"] = 0 if infos["matches"] is None else infos["matches"]
        text = None
        ...
        if text is not None:
            ...
            text_ctrl.SetSize(wx.Size(100,100))
