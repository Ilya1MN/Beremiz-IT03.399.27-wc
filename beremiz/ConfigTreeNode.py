...
class ConfigTreeNode:
    ...
    def CTNGenerate_C(self, buildpath, locations):
        ...
        """
        self.GetCTRoot().logger.write_warning(".".join([str(x) for x in self.GetCurrentLocation()]) + " -> Nothing to do\n")
        return [], "", False
    ...
    def IterChildren(self):
        for CTNType, Children in list(self.Children.items()):
        ...
        class FinalCTNClass(CTNClass, ConfigTreeNode):
            ...
            def __init__(_self):
                ...
                if os.path.isdir(_self.CTNPath(NewCTNName)):  # and os.path.isfile(_self.ConfNodeXmlFilePath(CTNName)):
                    ...
                    try:
                        self.InputInterfaceInfos = _self.YAPLCParser.GetPlcInputInterfaceInfos()
                        self.OutputInterfaceInfos = _self.YAPLCParser.GetPlcOutputInterfaceInfos()
                        self.MemoryInterfaceInfos = _self.YAPLCParser.GetPlcMemoryInterfaceInfos()
