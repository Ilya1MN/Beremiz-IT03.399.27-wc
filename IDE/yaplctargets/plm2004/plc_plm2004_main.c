...
static CopyFunc_t CopyVarsApp = {.CopyAppToMb = &CopyArrayAppToMbPtr[0],
 ...
 *  @return None.
 */
//void PlcApp_DISetCfgEnc(BOOL *Ex, BYTE *DIn, DWORD *SpA, BOOL *EnCmpMdA, DWORD *SpB, BOOL *EnCmpMdB, WORD *SpT, BOOL *EnCmpMdT, BYTE *SpMultiple, BYTE *Ok)
 ...
 *  @return None.
 */
//void PlcApp_DIStateCfgEnc(BYTE *DIn, DWORD *OSpA, BOOL *OEnCmpMdA, DWORD *OSpB, BOOL *OEnCmpMdB, WORD *OSpT, BOOL *OEnCmpMdT, *SpMultiple, BYTE *Ok)
