...
typedef struct
{
    ...
    void (*DISetCfgEnc)(BOOL *, BYTE *, DWORD *, BOOL *, DWORD *, BOOL *, WORD *, BOOL *, BYTE *, BYTE *);
    void (*DIStateCfgEnc)(BYTE *, DWORD *, BOOL *, DWORD *, BOOL *, WORD *, BOOL *, BYTE*, BYTE *);
    //-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    void (*StepMove)(BOOL *, BOOL *, BYTE *, BYTE *, BYTE *, WORD *, WORD *, WORD *, WORD *, DWORD *, BOOL *, WORD *, WORD *, WORD *, BYTE *, BYTE *, BYTE *);
    void (*StepStatus)(BYTE *, BYTE *, BYTE *, BYTE *);
...
typedef enum event_modes fast_task_event_t;

typedef struct cond_struct_t cond_struct_t;

typedef struct _fast_App_t_
{
    void (*FastPrograms_Ptr[32])();
    uint8_t SzFastFunc;
    cond_struct_t *cond_str;
}fastApp_t;

/** @typedef Pointer copy funcs
 * Array func copying for used application variable
 * CopyMbToApp - pointer to copy function from modbus register in application variables
 * CopyAppToMb - pointer to copy function from application variables in modbus register
 * Sz - size used application variables
*/
typedef struct _CopyVars_t_
{
    uint8_t (**CopyMbToApp)(void*);
    uint8_t (**CopyAppToMb)(void*);
    uint16_t *RegInd;
    uint16_t Sz;
} CopyFunc_t;
